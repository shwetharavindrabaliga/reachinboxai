...
import logo from '../components/Logo_1.png'
...
const Login = () => {
  ...
  return (
    <div className="bg-black m-auto text-white  flex flex-col justify-between">
      <div className=" w-full h-16 flex justify-center items-center border-b border-slate-800">
        <img src={logo} alt="reachinbox-logo" className="h-7" />
        <p className="font-bold ml-1">REACHINBOX</p>
      </div>
        ...
        <div className=" m-auto w-[460px] h-auto md:h-[312px]  bg-[#111214] rounded-2xl border border-gray-700  py-6  px-10 ">
          <div className=" w-[380px] m-auto">
            ...
            <div className="rounded border border-gray-500 h-12 flex justify-center items-center gap-2.5  mb-12">
              ...
              <Link
                to="https://hiring.reachinbox.xyz/api/v1/auth/google-login?redirect_t0=https://reachinboxai-topaz.vercel.app/desktop"
