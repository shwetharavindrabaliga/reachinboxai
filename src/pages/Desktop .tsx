...
const Desktop = () => {
    ...
    return (
        <div className={`w-screen h-full m-auto ${currColor ? "bg-black" : "bg-white"} ${currColor ? "text-white" : "text-black"} h-10 flex`}>
            ...
            <div  className='w-full max-w-[1383]'>
                <div className={` h-[64px] flex justify-between py-4 pl-8 ${currColor ? "bg-[#1F1F1F]" : "bg-white"} border-b ${currColor ? "border-gray-700":"border-gray-300" } `}>
